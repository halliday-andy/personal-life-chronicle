...
## 1. The proposal card
- [ ] /review shows lime **"New mention"** cards: "*Rick Toll* is mentioned in
      your recollection at *Year 2 at Mt. Snow* — add them as a person?" with
      an excerpt of the recollection. **[taste]** the card wording.
- [ ] **Add as person** on a clean proper name (e.g. Mike Paplow) → the card
...
- [ ] The **type selector** next to the name defaults to the nomination but
...
- [ ] **Dismiss** something you don't want in the graph (e.g. "SAC" or
