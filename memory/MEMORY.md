...
- [Project: LC build progress](project_lc_build_progress.md) — **refreshed 2026-07-26** (top "Session handoff" block = current state: pin-facts editor UI shipped, closing the 07-10 design — three new class-of-bug rules on single writers/readers/vocabularies; Phase-1 QA continuing at the trip-from-here checklist); Steps 1–6 complete; **Step 7: Slices 1, 2, 4a, 4b + globe-legibility track (3/3.5/3.6) + Slice 6 (Entity View + context incl. 6.5b) + Hopper 5a + globe stub resolution + /memories owner-edit + Journey J1–J5 + SLICE 7 (Person page + Life's Cast + Hopper 5b, all four phases, 2026-07-07) all shipped — the 2026-06-22 roadmap's slice list is exhausted; parked: Vertical Moments, pin-visual redesign, /memories full-text search**. Also records the 07-06/07 incidents + guards (words-are-not-actions; merge substance preservation; role='location' hijack). Read first when resuming build work. **2026-07-17: archived down to the two current handoff blocks** (07-15, 07-05) plus the "How to apply" footer; earlier history (Step 5 through Slice 2, May–mid-June 2026) moved to [project_lc_build_progress_archive_2026H1.md](project_lc_build_progress_archive_2026H1.md) — nothing deleted, just split out to keep this file fast to scan.
- [Project: LC strategic direction — Spine & Share (2026-07-17)](project_lc_direction_2026-07-17.md) — **The active north star.** Track A: complete birth-to-now residential spine in weeks (loose-ends surface as engine, undaunting by requirement); Track B: shareable spine + **shareable collections** (multi-recollection experience shares with collaborator commentary). Canonical roadmap `docs/plans/2026-07-17-spine-and-share-roadmap.md`; all open QA consolidated into `docs/qa/2026-07-17-master-qa-sequence.md`. Plans folder archived/re-homed same day.
...
- [Reference: LC user-facing knowledge base](reference_lc_knowledge_base.md) — `documentation/knowledge-base/`: the permanent support KB backing future capture-assistant guidance (seeded 2026-07-19); **update articles in the same PR as any capture-flow change**; assistant lookup-tool integration pending (roadmap §5)
...
- [Feedback: accessibility deferred, not dropped](feedback_lc_accessibility_deferral.md) — Andy 2026-07-26: dedicated keyboard-a11y work waits for post-MVP, but free-with-the-build semantics (aria, sr-only, real buttons) always ship, and take the accessible path whenever a feature makes it cheap. Running deferred list in roadmap §5
