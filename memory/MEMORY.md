...
- [Project: LC build progress](project_lc_build_progress.md) — **refreshed 2026-07-07** (top "Session handoff" block = current state); Steps 1–6 complete; **Step 7: Slices 1, 2, 4a, 4b + globe-legibility track (3/3.5/3.6) + Slice 6 (Entity View + context incl. 6.5b) + Hopper 5a + globe stub resolution + /memories owner-edit + the JOURNEY surface (J1–J5, complete 2026-07-07) all shipped. Next build: Slice 7 (Person page + Life's Cast + Hopper 5b)**. Also records the 07-06/07 incidents + guards (words-are-not-actions; merge substance preservation; role='location' hijack). Read first when resuming build work.
