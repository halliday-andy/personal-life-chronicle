...
- **Active forward track (2026-07-15):** Trips & Travel Journal — canonical plan `docs/plans/2026-07-15-001-feat-trips-travel-journal-plan.md` (first-class Trips over existing pins, destination-first drafts, globe route layer, Travel Journal mode in Journey, frequent-traveler package, Future Places pin). Origin: Codex brainstorm PDF at `documentation/research/2026-07-15-trips-and-travel-brainstorm-codex.pdf`. Succeeds the exhausted 2026-06-22 roadmap slice list.
